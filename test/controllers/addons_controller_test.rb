...
class AddonsControllerTest < ActionController::TestCase
  ...
  test "should create addon" do
    assert_difference('Addon.count') do
      post :create, addon: { curse: @addon.curse, description: @addon.description, name: @addon.name, required: @addon.required, wowinterface: @addon.wowinterface }
    end
  ...
  test "should update addon" do
    patch :update, id: @addon, addon: { curse: @addon.curse, description: @addon.description, name: @addon.name, required: @addon.required, wowinterface: @addon.wowinterface }
    assert_redirected_to addon_path(assigns(:addon))
  end
